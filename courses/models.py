...
class Course(Utility):
    ...
    image = models.ImageField(upload_to="courses", null=True, blank=True, verbose_name="Kurs rasmi",
                              validators=[
                                  FileExtensionValidator(allowed_extensions=['jpg', 'png', 'jpeg', 'webp', 'svg'])])
    price_per_month = models.DecimalField(null=False, blank=False, verbose_name="Kursning narxi (oylik)", max_digits=10,
                                          decimal_places=2)
...
class CourseLessonVideo(Utility):
    ...
    video = models.FileField(upload_to='lesson_videos/', null=True, blank=True, verbose_name="Video",
                             validators=[FileExtensionValidator(
                                 allowed_extensions=['mp4', 'mkv', 'avi', 'mov', 'wmv', 'webm', 'flv'])])
