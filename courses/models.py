...
class Course(Utility):
    ...
    price_per_moths = models.DecimalField(null=False, blank=False, verbose_name="Umumiy narxi(oylik)", max_digits=10,
                                          decimal_places=2)
...
class Portfolio(Utility):
    ...
    mentor=models.ForeignKey(Mentor,on_delete=models.SET_NULL,null=True,blank=True,related_name="portfolios",verbose_name="Mentor")
