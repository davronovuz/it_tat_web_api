...
class Course(Utility):
    ...
    technologies = models.ManyToManyField('Technology', verbose_name="Teglar", related_name="courses")
...
class CourseLessonVideo(Utility):
    title = models.CharField(max_length=255, null=True, blank=True, verbose_name="Video nomi")
    ...
    video = models.FileField(upload_to='lesson_videos/', null=True, blank=True, verbose_name="Video",
                             validators=[FileExtensionValidator(allowed_extensions=['mp4', 'mkv', 'avi', 'mov','wmv','flv'])])
...
class FAQ(Utility):
    ...
    question = models.TextField(null=False, blank=False, verbose_name="Savol")
    answer = models.TextField(null=False, blank=False, verbose_name="Javob")
